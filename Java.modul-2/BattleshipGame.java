...
public class BattleshipGame {
    ...
    System.out.println("Топ результатов игры:");

    if (gameTimes.isEmpty()) {
        System.out.println("Запесей об результатов игры, нет.");
        return;
    }

    // Сортировка результатов времени игры по возрастанию
        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1:
                    ...
                    long gameTime = (endTime - startTime) / 1000; // Полное продолжительность игры (в секундах)
